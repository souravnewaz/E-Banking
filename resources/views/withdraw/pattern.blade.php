...
@section('title')
<title>Withdraw Confirmation | E-Banking</title>
@endsection
    ...
    <div class="grid grid-cols-1  gap-3 justify-items-center">
        <div>
            ...
            <audio id="track" autoplay>
                <source src="/audio/withdraw-pattern.mp3" type="audio/mpeg" />
            </audio>
        </div>
        <div class="flex flex-col">
            <div class="w-full flex justify-center">
                <div class="h-12 w-12 rounded ">
                    <img src="/images/agent.jpg" alt="" class="rounded-lg">
                </div>
            </div>
            
            <div class="bg-white h-20 w-48 border-2 border-gray-200 text-center text-sm text-gray-500 rounded-lg p-2">
                <p class="">Md. Sharif</p>
